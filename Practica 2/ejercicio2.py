...
#Separa las palabras del texto y las guarda en una lista
palabras = texto.lower().split()

#Cuenta la cantidad y guarda en un diccionario donde las claves son las palabras
cant_palabras = Counter(palabras)

#Imprime la palabra mas repetida
print(cant_palabras.most_common(1)) 
